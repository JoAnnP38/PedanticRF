...
namespace Pedantic.Utilities
{
    public ref struct ValueStringBuilder
    {
        ...
        public int Length
        {
            ...
            {
                Util.Assert(value >= 0);
                Util.Assert(value <= _chars.Length);
                _pos = value;
            }
        }
        ...
        public void Append(int n)
        {
            ...
            if (n.TryFormat(numString, out int charsWritten))
            {
                ...
                numString.Slice(0, charsWritten).CopyTo(_chars.Slice(_pos));
                _pos += charsWritten;
            }
        }
        ...
        {
            Util.Assert(additionalCapacityBeyondPos > 0);
            Util.Assert(_pos > _chars.Length - additionalCapacityBeyondPos, "Grow called incorrectly, no resize is needed.");
