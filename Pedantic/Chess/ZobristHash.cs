// <copyright file="ZobristHash.cs" company="JoAnn D. Peeler">
...
namespace Pedantic.Chess
{
    ...
    public static class ZobristHash
    {
        ...
        public static ulong HashPiece(ulong hash, Color color, Piece piece, SquareIndex index)
        {
            return hash ^ GetPieceKey((int)color, (int)piece, (int)index);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong HashEnPassant(ulong hash, SquareIndex enPassant)
        {
            return hash ^ GetEnPassantKey((int)enPassant.File());
        }
        ...
        private static readonly FixedArray<ulong> rand64 = new (781)
        {
        ...
        private static readonly FixedArray<ulong> castleKeys = new(16)
        {
            /*  0 */ 0ul,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetCastleKey(CastlingRights castle)
        {
            return castleKeys[(int)castle];
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetPieceKey(int color, int piece, int index)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetEnPassantKey(int file)
        {
            return rand64[rand64_en_passant_offset + file];
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetActiveColorKey(int activeColor)
        {
