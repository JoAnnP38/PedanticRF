...
namespace Pedantic.Chess
{
    ...
    public static class UciOptions
    {
        ...
        private static UciOptionSpin tmBranchFactor = new UciOptionSpin(OPT_TM_BRANCH_FACTOR, 33, 20, 40);
        private static UciOptionSpin tmDefMovesToGo = new UciOptionSpin(OPT_TM_DEF_MOVES_TO_GO, 28, 20, 40);
        ...
        private static UciOptionSpin tmAbsoluteLimit = new UciOptionSpin(OPT_TM_ABSOLUTE_LIMIT, 4, 2, 8);
        private static UciOptionSpin tmDifficultyMin = new UciOptionSpin(OPT_TM_DIFFICULTY_MIN, 80, 0, 100);
        ...
        private static UciOptionSpin nmpIncDivisor = new UciOptionSpin(OPT_NMP_INC_DIVISOR, 6, 2, 8);
        private static UciOptionSpin lmrDepthFactor = new UciOptionSpin(OPT_LMR_DEPTH_FACTOR, 24, 10, 30);
        private static UciOptionSpin lmrMoveFactor = new UciOptionSpin(OPT_LMR_MOVE_FACTOR, 8, 5, 20);
        private static UciOptionSpin lmrScaleFactor = new UciOptionSpin(OPT_LMR_SCALE_FACTOR, 18, 10, 30);
        private static UciOptionSpin rfpMaxDepth = new UciOptionSpin(OPT_RFP_MAX_DEPTH, 7, 4, 12);
        private static UciOptionSpin rfpMargin = new UciOptionSpin(OPT_RFP_MARGIN, 121, 25, 250);
        private static UciOptionSpin lmpMaxDepth = new UciOptionSpin(OPT_LMP_MAX_DEPTH, 4, 1, 10);
        private static UciOptionSpin lmpDepthIncrement = new UciOptionSpin(OPT_LMP_DEPTH_INCREMENT, 5, 0, 10);
        private static UciOptionSpin futMaxDepth = new UciOptionSpin(OPT_FUT_MAX_DEPTH, 8, 1, 10);
        private static UciOptionSpin futMargin = new UciOptionSpin(OPT_FUT_MARGIN, 111, 35, 200);
        ...
        private static UciOptionSpin seeCaptureMargin = new UciOptionSpin(OPT_SEE_CAPTURE_MARGIN, 80, 25, 200);
        private static UciOptionSpin seeQuietMargin = new UciOptionSpin(OPT_SEE_QUIET_MARGIN, 32, 25, 200);
        private static UciOptionSpin lzyEvalMargin = new UciOptionSpin(OPT_LZY_EVAL_MARGIN, 645, 0, 1200);
        private static UciOptionSpin rzrMaxDepth = new UciOptionSpin(OPT_RZR_MAX_DEPTH, 3, 0, 5);
        private static UciOptionSpin rzrMargin = new UciOptionSpin(OPT_RZR_MARGIN, 116, 50, 400);
