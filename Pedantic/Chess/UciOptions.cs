...
namespace Pedantic.Chess
{
    ...
    public static class UciOptions
    {
        ...
        private static UciOptionSpin tmDefMovesToGo = new UciOptionSpin(OPT_TM_DEF_MOVES_TO_GO, 25, 20, 40);
        ...
        private static UciOptionSpin tmDifficultyMin = new UciOptionSpin(OPT_TM_DIFFICULTY_MIN, 78, 0, 100);
        private static UciOptionSpin tmDifficultyMax = new UciOptionSpin(OPT_TM_DIFFICULTY_MAX, 209, 100, 300);
        ...
        private static UciOptionSpin rfpMargin = new UciOptionSpin(OPT_RFP_MARGIN, 120, 25, 250);
        ...
        private static UciOptionSpin futMargin = new UciOptionSpin(OPT_FUT_MARGIN, 125, 35, 200);
        ...
        private static UciOptionSpin lzyEvalMargin = new UciOptionSpin(OPT_LZY_EVAL_MARGIN, 564, 0, 1200);
        private static UciOptionSpin rzrMaxDepth = new UciOptionSpin(OPT_RZR_MAX_DEPTH, 4, 0, 5);
        private static UciOptionSpin rzrMargin = new UciOptionSpin(OPT_RZR_MARGIN, 95, 50, 400);
        private static UciOptionSpin hisMaxBonus = new UciOptionSpin(OPT_HIS_MAX_BONUS, 1720, 500, 2500);
        private static UciOptionSpin hisBonusCoefficient = new UciOptionSpin(OPT_HIS_BONUS_COEFF, 172, 50, 250);
        private static UciOptionSpin lmrHistoryDiv = new UciOptionSpin(OPT_LMR_HISTORY_DIV, 5145, 2048, 16384);
        ...
        private static UciOptionSpin sexMinDepth = new UciOptionSpin(OPT_SEX_MIN_DEPTH, 9, 4, 12);
    }
}
