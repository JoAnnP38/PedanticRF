...
namespace Pedantic.Chess
{
    ...
    public static class UciOptions
    {
        ...
        private static UciOptionSpin tmDifficultyMin = new UciOptionSpin(OPT_TM_DIFFICULTY_MIN, 83, 0, 100);
        private static UciOptionSpin tmDifficultyMax = new UciOptionSpin(OPT_TM_DIFFICULTY_MAX, 201, 100, 300);
        ...
        private static UciOptionSpin lmrDepthFactor = new UciOptionSpin(OPT_LMR_DEPTH_FACTOR, 20, 10, 30);
        private static UciOptionSpin lmrMoveFactor = new UciOptionSpin(OPT_LMR_MOVE_FACTOR, 12, 5, 20);
        ...
        private static UciOptionSpin rfpMargin = new UciOptionSpin(OPT_RFP_MARGIN, 114, 25, 250);
        ...
        private static UciOptionSpin futMargin = new UciOptionSpin(OPT_FUT_MARGIN, 124, 35, 200);
        ...
        private static UciOptionSpin seeCaptureMargin = new UciOptionSpin(OPT_SEE_CAPTURE_MARGIN, 96, 25, 200);
        private static UciOptionSpin seeQuietMargin = new UciOptionSpin(OPT_SEE_QUIET_MARGIN, 35, 25, 200);
        private static UciOptionSpin lzyEvalMargin = new UciOptionSpin(OPT_LZY_EVAL_MARGIN, 571, 0, 1200);
        ...
        private static UciOptionSpin hisMaxBonus = new UciOptionSpin(OPT_HIS_MAX_BONUS, 1739, 500, 2500);
        private static UciOptionSpin hisBonusCoefficient = new UciOptionSpin(OPT_HIS_BONUS_COEFF, 168, 50, 250);
        private static UciOptionSpin lmrHistoryDiv = new UciOptionSpin(OPT_LMR_HISTORY_DIV, 5211, 2048, 16384);
        private static UciOptionSpin sexDepthMult = new UciOptionSpin(OPT_SEX_DEPTH_MULT, 20, 4, 32);
